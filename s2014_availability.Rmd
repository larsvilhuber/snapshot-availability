...
> Users who wish to consider different variables than the ones we show here should feel free to [clone this git repository](https://github.com/larsvilhuber/snapshot-availability), and change parameters of interest, or access our [interactive webpage](http://www.ncrn.cornell.edu:3838/LEHD_Snapshot/).
...
write.csv(x = industry,file="qwi_industry_extract.csv")
```
...
> An interactive version of these graphs can be found at http://www.ncrn.cornell.edu:3838/LEHD_Snapshot/.  
