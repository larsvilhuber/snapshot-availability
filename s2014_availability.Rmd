...
There are as of this date two versions of the MOU that binds the Census Bureau and state agencies in effect: The original MOU, signed when the state first joined the LED Program, and a successor MOU, mostly standardized across states, that states signed when the first MOU expired after 10 years. The original MOU was used for the S2008 snapshot, and subsequent snapshots have been faced with a mixture of both.
...
mous <- read.xls(paste(xlsloc,"/","CMS download_",xlsversion,".xls",sep=""),sheet = 1)
