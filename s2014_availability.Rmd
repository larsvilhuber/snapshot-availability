...
```{r MCAR,echo=FALSE,results="asis",warning=FALSE,error=FALSE,collapse=TRUE,message=FALSE}
gindustry2 <- gindustry
gindustry2[gindustry2$Option == "NA",c("Option")]<- "B" 
gindustry2$Option <- relevel(gindustry2$Option, ref= "A")
...
pander(mylogit,caption = paste("Test of MCAR for `",usevar,"` (conditional on mapping `NA` into `B`)",sep=""))
```
